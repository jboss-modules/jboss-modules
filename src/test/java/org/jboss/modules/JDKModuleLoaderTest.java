...
public class JDKModuleLoaderTest extends AbstractModuleTestCase {
    ...
    public void testLoadModulesClassFile() throws ModuleLoadException {
        ...
        assertNotNull(resource, "Main.class");
    }
    ...
    public void testJavaSeModuleLoad() throws Exception {
        ...
        assertNotNull(module, "java.se module not found");
        final String resultSetClassName = "java.sql.ResultSet";
        final Class<?> klass = module.getClassLoader().loadClass(resultSetClassName);
        assertNotNull(klass, resultSetClassName + " class couldn't be loaded from java.se module");
        ...
        assumeTrue(matcher.matches() && Integer.parseInt(matcher.group(1)) >= 11,
                "Java 11 is required to test loading of classes in java.net.http module");
        ...
        assertNotNull(httpClientClass, httpClientClassName + " class couldn't be loaded from java.se module");
    }
}
