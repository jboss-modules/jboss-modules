...
When JBoss Modules runs on Java 11 or later, the module name and version will appear in the stack
...
As of JBoss Modules version 1.8, a set of modules are predefined and available for use
as dependencies when the default module loader is used.  The set of modules available
...
in log messages and other diagnostics when running under Java 11 or later.
