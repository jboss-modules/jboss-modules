 ...
 */
public class ModuleLoggerFinder extends LoggerFinder {
    ...
    private LoggerFinder resolveFinder() {
        ...
        if (result == null) {
            synchronized (this) {
                ...
                if (result == null) {
                    try {
                        final ServiceLoader<LoggerFinder> loader = ServiceLoader.load(LoggerFinder.class, LogManager.getLogManager().getClass().getClassLoader());
