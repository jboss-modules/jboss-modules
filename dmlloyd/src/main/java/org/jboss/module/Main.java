...
public final class Main {
    ...
    public static void main(String[] args) {
        ...
        final String scheme = moduleUri.getScheme();
        final ModuleLoader loader = ModuleLoader.getCurrent();
        final Module module;
        try {
            module = loader.loadModule(moduleUri);
        } catch (ModuleNotFoundException e) {
            System.err.printf("Module '%s' not found: %s", moduleUri, e);
            System.exit(1);
            return;
        }
